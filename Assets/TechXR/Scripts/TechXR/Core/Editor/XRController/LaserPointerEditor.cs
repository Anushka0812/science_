...
namespace TechXR.Core.Editor
{
    ...
    public class LaserPointerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                laserPointer.OculusTriggerButton = (LaserPointer.OculusButton)EditorGUILayout.EnumPopup("Trigger Button ", laserPointer.OculusTriggerButton);
            }
            else
            {
                laserPointer.SenseXRTriggerButton = (LaserPointer.XRButton)EditorGUILayout.EnumPopup("Trigger Button ", laserPointer.SenseXRTriggerButton);
            }
            //
